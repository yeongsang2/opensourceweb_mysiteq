  ...
  <!-- board list area -->
        <div class="container">
            <table class="board-table">
                ...
                blogList = (ArrayList<BlogDto>)request.getAttribute("blogList");
                for(int i=0; i< blogList.size() ; i++){
                	%>
                	<tr>
                	<td><%= blogList.get(i).getBlogId() %></td>
                	<td><%= blogList.get(i).getBlogTitle() %></td>
                	<td><%= blogList.get(i).getBlogAuthor() %></td>
                	<td><%= blogList.get(i).getBlogDate() %></td>
                	<td><a href="detail?blogId=<%=blogList.get(i).getBlogId()%>">글보기</a></td>
                	</tr>
   				<%
                }
                %>
...
<hr>	
<button style = "margin-right: 80px; margin-bottom: 30px; margin-top: 15px;float:right"><a href="write">글쓰기</button>
</body>
</html>
